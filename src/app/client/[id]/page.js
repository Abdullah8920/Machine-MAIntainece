  ...
  return (
    <div className="page">
      ...
      <div className="page-content">
        ...
        <HistoryTable records={history} onRecordClick={(machineId) => router.push(`/client/${id}/record/${machineId}`)} />
        ...
        <div style={{ marginTop: "12px" }}>
          <Button variant="secondary" onClick={() => router.push(`/add-machine?clientId=${id}`)}>
            + Add Another Visit
          </Button>
        </div>
      </div>
